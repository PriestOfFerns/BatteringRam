...
import io.github.priestoffern.vs_battering_ram.blocks.SpeedGauge.SpeedGaugeBlock
...
object VSBatteringRamBlocks {
    ...
    var SPEED_GAUGE: RegistrySupplier<SpeedGaugeBlock> = BLOCKS.register("speed_gauge") { SpeedGaugeBlock(BlockBehaviour.Properties.of(Material.WOOD).strength(2.0f).noOcclusion()) }
